...
with_node \
  ...
  --target "/Users/carl/Projects/expo/freshsweeperv5/ios/Pods/Target Support Files/Pods-freshsweeper/ExpoModulesProvider.swift" \
  --entitlement "/Users/carl/Projects/expo/freshsweeperv5/ios/freshsweeper/freshsweeper.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-camera" "expo-constants" "expo-crypto" "expo-device" "expo-eas-client" "expo-emoji-picker" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-linear-gradient" "expo-linking" "expo-location" "expo-media-library" "expo-screen-orientation" "expo-sharing" "expo-splash-screen" "expo-updates" "expo-web-browser"
