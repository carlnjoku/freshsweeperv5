...
const GroupActions = ({ 
  ...
  return (
    <View style={styles.actionsRow}>
      ...
      {/* Left Side - Details Button */}
      <TouchableOpacity 
        style={[styles.button, styles.detailButton, disabled && styles.disabledButton]} 
        onPress={onDetails}
        disabled={disabled}
      >
        <Text style={[styles.detailText, disabled && styles.disabledText]}>
      ...
      {isSelected ? (
        ...
        <View style={styles.rightWrapper}>
          ...
          <TouchableOpacity 
            style={[styles.button, styles.declineButton, disabled && styles.disabledButton]} 
            onPress={onDecline}
            disabled={disabled}
          >
            <Text style={[styles.buttonText, disabled && styles.disabledText]}>
              {tSafe("decline", "Decline")}
            </Text>
          </TouchableOpacity>
        </View>
      )}
