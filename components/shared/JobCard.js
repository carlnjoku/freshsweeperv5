      ...
      <Card style={styles.card}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.dateRow}>
            <Ionicons name="calendar-outline" size={14} color={COLORS.gray} />
            <Text style={styles.date}>
              {tSafe('completed_prefix', 'Completed')} {moment(schedules?.completed_on?.$date || schedules?.completed_on).format('MMM DD, YYYY [at] h:mm A')}
            </Text>
          </View>
            ...
            <View style={styles.propertySection}>
              ...
              <View style={styles.propertyStats}>
                <View style={styles.statItem}>
                  <Ionicons name="time-outline" size={16} color={COLORS.gray} />
                  <Text style={styles.statText}>
                    {schedules?.schedule?.total_cleaning_time || 0} {tSafe('minutes_abbr', 'min')}
                  </Text>
                </View>
                <View style={styles.statItem}>
                  <Ionicons name="cash-outline" size={16} color={COLORS.gray} />
                ...
                <View style={styles.statItem}>
                  <Ionicons name="location-outline" size={16} color={COLORS.gray} />
                  <Text style={styles.statText} numberOfLines={1}>
                    {schedules?.schedule?.address?.split(',')[0] || tSafe('unknown_address', 'Unknown address')}
                  </Text>
                </View>
              </View>
            </View>
