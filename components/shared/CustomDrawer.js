...
//   [ROUTES.cleaner_earnings]: { icon: 'credit-card-outline', family: MaterialCommunityIcons },
//   [ROUTES.cleaner_settings]: { icon: 'settings-outline', family: Ionicons },
//   [ROUTES.cleaner_support]: { icon: 'lifebuoy', family: MaterialCommunityIcons },
//   [ROUTES.cleaner_my_gigs]: { icon: 'briefcase-outline', family: MaterialCommunityIcons },
...
//   useEffect(() => {
//     const checkHostProperties = async () => {
//       if (userType === 'host') {
//         try {
//           // Replace with your actual API call to fetch host properties
//           const response = await userService.getPropertiesByHost(currentUserId);
...
//       }
//     };
//     if (currentUserId && userType === 'host') {
//       checkHostProperties();
//     }
//   }, [currentUserId, userType]);

//   // Define screens based on user type with translations
//   const getScreens = () => {
//     if (userType === 'host') {
//       return [
//         { name: ROUTES.host_home_drawer, label: tSafe('drawer_home', 'Home') },
//         { name: ROUTES.notification, label: tSafe('drawer_notifications', 'Notifications') },
//         { name: ROUTES.host_profile, label: tSafe('drawer_my_profile', 'My Profile') },
//         { name: ROUTES.host_team, label: tSafe('drawer_my_team', 'My Team') },
//         { name: ROUTES.host_my_apartment, label: tSafe('drawer_my_properties', 'My Properties') },
//         { name: ROUTES.host_checklist, label: tSafe('drawer_my_checklists', 'My Checklists') },
//         { name: ROUTES.host_payment_history, label: tSafe('drawer_payment_history', 'Payment History') },
//         { name: ROUTES.cleaner_support, label: tSafe('drawer_support', 'Support') },
//         { name: ROUTES.cleaner_settings, label: tSafe('drawer_settings', 'Settings') },
//       ];
//     } else {
//       // Cleaner base screens
//       const base = [
//         { name: ROUTES.cleaner_home_drawer, label: tSafe('drawer_home', 'Home') },
//         { name: ROUTES.notification, label: tSafe('drawer_notifications', 'Notifications') },
//         { name: ROUTES.cleaner_profile, label: tSafe('drawer_my_profile', 'My Profile') },
//         { name: ROUTES.cleaner_earnings, label: tSafe('drawer_my_earnings', 'My Earnings') },
//         { name: ROUTES.cleaner_settings, label: tSafe('drawer_settings', 'Settings') },
//         { name: ROUTES.cleaner_support, label: tSafe('drawer_support', 'Support') },
//       ];
//       if (hasLinked) {
...
//         return [
//           ...base.slice(0, 3),
//           { name: ROUTES.cleaner_my_gigs, label: tSafe('drawer_my_gigs', 'My Gigs') },
//           ...base.slice(3),
//         ];
//       }
//       return base;
...
//   [ROUTES.host_profile]: { icon: 'account-outline', family: MaterialCommunityIcons },
//   [ROUTES.host_team]: { icon: 'account-group-outline', family: MaterialCommunityIcons },
//   [ROUTES.host_team_list]: { icon: 'briefcase-outline', family: MaterialCommunityIcons },
//   [ROUTES.host_my_apartment]: { icon: 'home', family: AntDesign },
//   [ROUTES.host_checklist]: { icon: 'check-square', family: Feather },
//   [ROUTES.host_payment_history]: { icon: 'credit-card-clock', family: MaterialCommunityIcons },
// };
...
//   // For hosts, check if they have at least one property
//   useEffect(() => {
//     const checkHostProperties = async () => {
//       if (userType === 'host') {
//         try {
...
//   // Define screens based on user type with translations and conditional visibility
//   const getScreens = () => {
//     if (userType === 'host') {
//       // Base screens that always appear
//       const hostScreens = [
//         { name: ROUTES.host_home_drawer, label: tSafe('drawer_home', 'Home') },
//         { name: ROUTES.notification, label: tSafe('drawer_notifications', 'Notifications') },
//         { name: ROUTES.host_profile, label: tSafe('drawer_my_profile', 'My Profile') },
...
//       // Only add My Team and My Checklists if host has at least one property
//       if (hasProperties) {
//         hostScreens.push(
//           { name: ROUTES.host_team, label: tSafe('drawer_my_cleaner', 'My Cleaners') },
//           { name: ROUTES.host_team_list, label: tSafe('drawer_my_team__', 'Trusted Vendors') },
//           { name: ROUTES.host_checklist, label: tSafe('drawer_my_checklists', 'My Checklists') }
//         );
//       }
      
//       // Always show My Properties (to create first property) and the rest
//       hostScreens.push(
//         { name: ROUTES.host_my_apartment, label: tSafe('drawer_my_properties', 'My Properties') },
//         { name: ROUTES.host_payment_history, label: tSafe('drawer_payment_history', 'Payment History') },
//         { name: ROUTES.cleaner_support, label: tSafe('drawer_support', 'Support') },
...
//         return [
//           ...base.slice(0, 3),
//           { name: ROUTES.cleaner_my_gigs, label: tSafe('drawer_my_cleanings', 'My Cleanings') },
//           ...base.slice(3),
//         ];
//       }
//       return base;
