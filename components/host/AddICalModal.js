...
//                   <Text style={styles.switchLabel}>{enabled ? 'Active' : 'Paused'}</Text>
//                   <Text style={styles.switchSubtitle}>
//                     {enabled
//                       ? 'Cleaning schedules will be automatically created'
//                       : 'No schedules will be created for this calendar'}
//                   </Text>
//                 </View>
//                 <Switch
//                   value={enabled}
...
//                         <Text style={styles.helpLink}>Where to find it?</Text>
//                       </TouchableOpacity>
//                     </View>
//                     <TextInput
//                       mode="outlined"
...
//                     <Text style={styles.sectionTitle}>Assigned Cleaners (Optional)</Text>
//                     <Text style={styles.subtitle}>
//                       Select cleaners to assign to this calendar's cleanings
//                     </Text>
//                     <View style={styles.cleanerOptions}>
//                       {cleaners.map(cleaner => (
//                         <TouchableOpacity
...
//                         </TouchableOpacity>
//                       ))}
//                       {cleaners.length === 0 && <Text style={styles.noCleanersText}>No cleaners available</Text>}
//                     </View>
//                   </Animatable.View>
...
//                               <Text style={styles.checklistName}>
//                                 {checklist.checklistName}
//                                 {checklist.default_checklist && <Text style={styles.defaultBadge}> (Default)</Text>}
//                               </Text>
//                               <Text style={styles.checklistDetails}>
//                                 {Object.keys(checklist.checklist).length} group(s) · ${checklist.totalFee} ·{' '}
//                                 {calculateTotalTasks(checklist)} tasks
//                               </Text>
//                             </View>
//                           </TouchableOpacity>
