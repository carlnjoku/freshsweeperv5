                        ...
                        <View style={styles.container}>
                            ...
                            <CustomCard>
                                <View style={styles.cardContainer}>
                                    <View style={styles.cardHeader}>
                                        <View style={styles.headerLeft}>
                                            <Text style={styles.cardTitle}>{tSafe('cleaning_schedule', 'Cleaning Schedule')}</Text>
                                        </View>
                                        <View style={[styles.statusIndicator, { backgroundColor: COLORS.success + '20' }]}>
                                            <MaterialCommunityIcons name="check-circle" size={14} color={COLORS.success} />
                                            <Text style={[styles.statusText, { color: COLORS.success }]}>{tSafe('scheduled', 'Scheduled')}</Text>
                                        </View>
                                    </View>
