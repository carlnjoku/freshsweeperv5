...
export default function ViewCleanerProfile({ cleanerId, schedule, close_modal }) {
    ...
    return (
        <View style={styles.container}>
            <StatusBar translucent backgroundColor="transparent" />
            <View style={styles.avatar_background}>
                <View style={{ backgroundColor: COLORS.primary, marginRight: 15 }}>
                    <MaterialCommunityIcons name="close" style={styles.closeIcon} color={COLORS.white} size={26} onPress={onClose} />
                </View>
                <Avatar.Image
                    size={100}
                    source={{ uri: avatar }}
