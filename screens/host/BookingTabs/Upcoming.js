...
export default function Upcoming({ schedules, currency, isLoading = false }) {
  ...
  const renderEmptyState = (type = 'general') => {
    const messages = {
      general: {
        icon: 'calendar-blank',
        title: tSafe('upcoming_empty_general_title', 'No Upcoming Schedules'),
        message: tSafe('upcoming_empty_general_message', 'You don’t have any upcoming cleaning schedules. New bookings will appear here once confirmed.')
      },
      booked: {
        icon: 'calendar-plus',
        title: tSafe('upcoming_empty_booked_title', 'No Bookings Yet'),
        message: tSafe('upcoming_empty_booked_message', 'Your upcoming cleaning appointments will show up here once they are booked and confirmed.')
      },
      confirmed: {
        icon: 'calendar-check',
        title: tSafe('upcoming_empty_confirmed_title', 'No Confirmed Schedules'),
        message: tSafe('upcoming_empty_confirmed_message', 'Confirmed cleaning schedules will appear here. Check your pending requests for unconfirmed bookings.')
      },
      error: {
        icon: 'alert-circle-outline',
        title: tSafe('upcoming_empty_error_title', 'Unable to Load Schedules'),
        message: tSafe('upcoming_empty_error_message', 'There was an issue loading your upcoming schedules. Please pull down to refresh.')
      }
    };
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        <ActivityIndicator size="large" color={COLORS.primary} />
        <Text style={styles.loadingText}>{tSafe('loading_upcoming_schedules', 'Loading upcoming schedules...')}</Text>
      </View>
    );
  }
