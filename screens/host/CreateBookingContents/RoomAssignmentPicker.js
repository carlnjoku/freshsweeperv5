...
//     return {
//       groupId,
//       label: `${tSafe('group', 'Group')} ${groupId.toUpperCase()}`,
//       value: groupId,
//     };
//   });
...
//                   {tSafe('assigned_to_group_a', 'Assigned to Group A')}
//                 </Text>
//               )}
...
//                       {tSafe('group', 'Group')} {groupId.replace('group_', '').toUpperCase()}
//                     </Text>
...
//                 <Text style={{ fontWeight: 'bold', marginBottom: 10 }}>{tSafe('add_note', 'Add Note')}</Text>
//                 <TextInput
//                   mode="outlined"
//                   multiline
//                   numberOfLines={4}
...
//   // Reset assignments when switching back to 1 cleaner
//   useEffect(() => {
//     if (!hasInitialized) return;
    
//     if (expectedCleaners === 1) {
//       console.log('Switching to single cleaner mode - resetting assignments');
