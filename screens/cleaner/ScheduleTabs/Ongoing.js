...
export default function Ongoing({ schedules, isLoading = false }) {
  ...
  const renderEmptyState = (type = 'general') => {
    const messages = {
      general: {
        icon: 'progress-clock',
        title: tSafe('ongoing_empty_general_title', 'No Ongoing Jobs'),
        message: tSafe('ongoing_empty_general_message', 'You don\'t have any cleaning jobs in progress right now. Ongoing jobs will appear here once you start working on assigned tasks.')
      },
      started: {
        icon: 'play-circle-outline',
        title: tSafe('ongoing_empty_started_title', 'No Jobs Started'),
        message: tSafe('ongoing_empty_started_message', 'You have assigned jobs but haven\'t started any yet. Tap on a job to begin cleaning and track your progress.')
      },
      active: {
        icon: 'run-fast',
        title: tSafe('ongoing_empty_active_title', 'No Active Work'),
        message: tSafe('ongoing_empty_active_message', 'You\'re not currently working on any cleaning jobs. Start a job to begin tracking your tasks and time.')
      },
      error: {
        icon: 'alert-circle-outline',
        title: tSafe('ongoing_empty_error_title', 'Unable to Load Jobs'),
        message: tSafe('ongoing_empty_error_message', 'There was an issue loading your ongoing jobs. Please pull down to refresh or check your connection.')
      }
    };
  ...
  if (isLoading) {
    return (
      <View style={styles.loadingContainer}>
        <ActivityIndicator size="large" color={COLORS.primary} />
        <Text style={styles.loadingText}>{tSafe('loading_ongoing_jobs', 'Loading ongoing jobs...')}</Text>
      </View>
    );
  }
