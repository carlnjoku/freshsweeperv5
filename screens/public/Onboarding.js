...
//   //       navigation.replace(userType === 'host' ? 'Host' : 'Cleaner');
//   //     } else if (hasAccount === 'true') {
//   //       // Has account but not logged in → go to LoginOptions
//   //       navigation.replace(ROUTES.login_options);
//   //     } else {
//   //       // Brand new user → go to GettingStarted
//   //       navigation.replace(ROUTES.getting_started);
//   //     }
//   //   };
//   //   checkUserStatus();
//   // }, []);
...
//         navigation.replace(userType === 'host' ? 'Host' : 'Cleaner');
//       } else {
//         // show onboarding or redirect to login options
//       }
//     }
//   }, [isLoading, userToken, userType]);
...
//         if (token) {
//           // If somehow token exists (shouldn't happen in onboarding), go to dashboard.
//           navigation.replace(userType === 'host' ? 'Host' : 'Cleaner');
//         } else if (hasAccount === 'true') {
//           // Returning user, not logged in – show LoginOptions
//           console.log('Returning user – redirecting to LoginOptions');
//           navigation.replace(ROUTES.login_options);
//         } else {
//           // New user – show onboarding slides (stay here)
...
//           style={styles.getStartedButton}
//           // onPress={async () => {
//           //   // Set the flag to indicate onboarding has been shown
//           //   await AsyncStorage.setItem('@onboarding_shown', 'true');
//           //   navigation.navigate(ROUTES.getting_started, { userType: 'cleaner' });
//           // }}
//           onPress={async () => {
//             console.log('🔵 Setting onboarding_shown flag...');
//             await AsyncStorage.setItem('@onboarding_shown', 'true');
//             const check = await AsyncStorage.getItem('@onboarding_shown');
//             console.log('🔵 Flag after set:', check);
//             navigation.navigate(ROUTES.getting_started, { userType: 'cleaner' });
//           }}
//           activeOpacity={0.8}
//         >
